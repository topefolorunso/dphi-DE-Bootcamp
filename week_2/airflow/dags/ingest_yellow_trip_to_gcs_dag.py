...
url = url_prefix + f'yellow_tripdata_{present_month}.parquet'

local_home = os.environ.get("AIRFLOW_HOME", "/opt/airflow/")
parquet_name = f"yellow_trips_{present_month}.parquet"

PROJECT_ID = os.environ.get("GCP_PROJECT_ID")
BUCKET = os.environ.get("GCP_GCS_BUCKET")

ingestion_workflow = DAG(
    "YellowTrip-GCP-Ingestion-DAG",
...
with ingestion_workflow:
    ...
    upload_to_gcs_task = PythonOperator(
        ...
        op_kwargs={
            "bucket": BUCKET,
            "object_name": f"raw/yellow_trips/{present_year}/{parquet_name}",
